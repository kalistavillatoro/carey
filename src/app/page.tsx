...
const sportsWords = [
  { text: 'Rowing',        size: 38 },
  { text: 'Cricket',       size: 36 },
  { text: 'Football',      size: 34 },
  { text: 'Netball',       size: 32 },
  { text: 'Swimming',      size: 30 },
  { text: 'Basketball',    size: 28 },
  { text: 'Soccer',        size: 26 },
  { text: 'Tennis',        size: 24 },
  { text: 'Athletics',     size: 23 },
  { text: 'Cross Country', size: 22 },
  { text: 'Water Polo',    size: 21 },
  { text: 'Volleyball',    size: 21 },
  { text: 'Golf',          size: 20 },
  { text: 'Field Hockey',  size: 20 },
  { text: 'Lacrosse',      size: 19 },
  { text: 'Baseball',      size: 19 },
  { text: 'Softball',      size: 18 },
  { text: 'Track & Field', size: 18 },
  { text: 'Gymnastics',    size: 18 },
  { text: 'Rugby',         size: 18 },
...
function AnimatedWord({
  ...
  if (hovered) {
    ...
    textDecorationColor = 'var(--accent-navy)';
  } else if (isHighlighted && highlighted) {
    const r = 184, g = 155, b = 60;
    ...
    <>
      ...
      <div ref={heroSectionRef} style={{ height: '200vh', position: 'relative' }}>
        <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: 'linear-gradient(to bottom, transparent 55%, rgba(12,15,28,0.45) 100%)',
            pointerEvents: 'none',
          }} />
          ...
          >
            <p style={{
              ...
              Structured pathways for Carey student-athletes pursuing U.S. collegiate programs.
            </p>
          </div>
      ...
      <section style={{ backgroundColor: 'var(--bg-primary)', padding: 'clamp(72px, 10vw, 120px) 24px' }}>
        <div ref={contextRef} style={{ maxWidth: '640px', margin: '0 auto' }}>
          <div className="fade-up" data-delay="0" style={{
            ...
            color: 'var(--accent-light-gold)', marginBottom: '32px',
          }}>
            The Landscape
          </div>
          ...
          <p className="fade-up" data-delay="200" style={{
            ...
            Through Carey Baptist Grammar School&apos;s CAPS partnership, student-athletes gain access to a disciplined, individually calibrated framework — one that helps them move through the recruiting process with clarity, confidence, and a competitive position that reflects the full scope of who they are.
          </p>
      ...
      <section style={{ backgroundColor: 'var(--bg-primary)', padding: 'clamp(72px, 10vw, 140px) 5vw clamp(60px, 8vw, 120px)' }}>
        <div style={{
          fontFamily: 'var(--font-mono)', fontSize: '11px',
          textTransform: 'uppercase', letterSpacing: '0.14em',
          color: 'var(--accent-light-gold)', marginBottom: '72px',
        }}>
          Reach · Sport · Outcome
        </div>
