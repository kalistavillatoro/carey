  ...
  return (
    <Link href={href} style={{ textDecoration: 'none' }}>
      <button
        ...
        style={{
          border: `1px solid ${hovered ? 'var(--accent-navy)' : 'var(--accent-light-gold)'}`,
          backgroundColor: hovered ? 'var(--accent-navy)' : 'transparent',
          color: hovered ? 'var(--text-primary)' : 'var(--accent-light-gold)',
...
const levels = [
  ...
  },
  {
    ...
    text: 'Advisor-led cohorts of athletes progressing through the recruiting cycle together. Each cohort includes structured sessions, shared milestones, and individualised feedback. Some cohorts are organised by sport or recruiting profile when appropriate.',
    delay: 0,
  },
  {
    label: 'Acceleration',
    title: 'Private Advisory',
    text: 'One-to-one strategic support for athletes and families requiring a fully individualised recruiting plan. This includes positioning, outreach strategy, profile development, school targeting, communication support, and ongoing decision guidance through the commitment process. Availability is intentionally limited.',
    delay: 0,
  },
];
      ...
      <div ref={pageRef} style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          <div className="fade-up" data-delay="0" style={{
            ...
            color: 'var(--accent-light-gold)', marginBottom: '24px',
          }}>
            How We Work
          </div>
          <h1 className="fade-up heading-interactive" data-delay="80" style={{
            ...
            Support that fits<br />where you are.
          </h1>
        </div>
        ...
        <p className="fade-up" data-delay="160" style={{
          ...
          color: 'var(--text-muted)', maxWidth: '580px', marginBottom: '48px',
        }}>
          Support is structured across three levels. Each Carey athlete is evaluated individually before a recommended level of support is made, based on sport, timeline, and recruiting readiness.
        </p>

        {/* ── Separator + disclaimer ── */}
        <div className="divider-animated" data-delay="0" style={{ marginBottom: '28px' }} />
        <div className="fade-up" data-delay="80" style={{
          fontFamily: 'var(--font-mono)', fontSize: '11px',
          ...
          <div key={level.label}>
            <div style={{ padding: '48px 0' }}>
              <div className="fade-up" data-delay="0" style={{
                fontFamily: 'var(--font-mono)', fontSize: '11px',
                textTransform: 'uppercase', letterSpacing: '0.14em',
                color: 'var(--accent-light-gold)', marginBottom: '16px',
              }}>
                {level.label}
              </div>
              <h2 className="fade-up heading-interactive" data-delay="80" style={{
                fontFamily: 'var(--font-serif)', fontWeight: 400,
                fontSize: '34px', color: 'var(--text-primary)',
        ...
        {/* ── Closing CTA ── */}
        <div className="divider-animated" data-delay="0" style={{ marginBottom: '80px' }} />
        <div className="fade-up" data-delay="0" style={{ paddingTop: '40px', textAlign: 'center' }}>
          <p style={{
            fontFamily: 'var(--font-sans)', fontWeight: 300,
            fontSize: '16px', lineHeight: 1.85,
