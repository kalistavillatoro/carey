...
function FocusInput({ type = 'text', name, required = false }: { type?: string; name: string; required?: boolean }) {
  ...
  return (
    <input
      ...
      style={{
        ...inputStyle,
        borderColor: focused ? 'var(--accent-navy)' : 'var(--border-input)',
      ...
      >
        ...
        <div className="apply-left-col" style={{ position: 'sticky', top: '140px' }}>
          ...
          <div style={{
            ...
            Carey Baptist Grammar School · Powered by CAPS
          </div>
        </div>
        ...
        <div className="apply-form-box" style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormField label="Year level at Carey">
              <FocusSelect
                name="year_level"
                required
                options={['Year 7', 'Year 8', 'Year 9', 'Year 10', 'Year 11', 'Year 12', 'Past student']}
              />
            </FormField>
            ...
            <FormField label="How did you hear about the Carey CAPS Portal? (optional)">
            ...
            <button
              ...
              style={{
                display: 'block',
                width: '100%',
                backgroundColor: submitHovered ? 'var(--accent-light-gold)' : 'var(--text-primary)',
