      ...
      <div ref={pageRef} style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ marginBottom: '80px' }}>
          <div className="fade-up" data-delay="60" style={{
            fontFamily: 'var(--font-mono)', fontSize: '11px',
            textTransform: 'uppercase', letterSpacing: '0.14em',
            color: 'var(--accent-light-gold)', marginBottom: '20px',
          }}>
            Carey & CAPS
          </div>
          <p className="fade-up" data-delay="140" style={{
            ...
            Carey Baptist Grammar School has partnered with CAPS (College Athlete Placement Standard) — an institutional framework designed to help high schools formalise and strengthen their athletic recruiting infrastructure. This portal is Carey&apos;s dedicated gateway into that system.
          </p>
          ...
          <p className="fade-up" data-delay="260" style={{
            ...
            Together, they represent a connected ecosystem: institutional structure for Carey, and individualised strategic guidance for Carey athletes.
          </p>
          <a className="fade-up" data-delay="320"
            href="https://www.capsglobal.org" target="_blank" rel="noopener noreferrer"
            style={{
              fontFamily: 'var(--font-sans)', fontWeight: 300,
              fontSize: '16px', color: 'var(--accent-light-gold)',
        ...
        <div style={{ marginBottom: '80px' }}>
          <div className="fade-up" data-delay="60" style={{
            fontFamily: 'var(--font-mono)', fontSize: '11px',
            textTransform: 'uppercase', letterSpacing: '0.14em',
            color: 'var(--accent-light-gold)', marginBottom: '28px',
          }}>
            Experience Across
          </div>
